      ...
      <div className="footer__container">
        ...
        <nav className="footer__menu">
          <div className="footer__menu-column">
            <h4 className="footer__menu-title">Products</h4>
            <Link to="/collections/kitchens">Kitchens</Link>
            <Link to="/collections/bathrooms">Bathrooms</Link>
            <Link to="/collections/Extra Collection">Extra Collection</Link>
          </div>
          <div className="footer__menu-column">
            <h4 className="footer__menu-title">Company</h4>
            <Link to="/about">About</Link>
            <Link to="/contacts">Contact</Link>
            <Link to="/projects">Bundles</Link>
          </div>
          <div className="footer__menu-column">
            <h4 className="footer__menu-title">Legal</h4>
            <Link to="/privacy-policy">Privacy Policy</Link>
            <Link to="/cookie-policy">Cookie Policy</Link>
            <Link to="/terms-conditions">Terms and Conditions</Link>
          </div>
          <div className="footer__menu-column">
            <h4 className="footer__menu-title">Follow Us</h4>
